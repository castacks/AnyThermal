...
parser = argparse.ArgumentParser(description='Fine-tuning DINO on ImageNet')
...
parser.add_argument('--save_path', default='./checkpoints_ce/dino_ms2_checkpoints_thermal_global_bigger_denser_no_night', type=str, help='Path to save the checkpoints')
...
rgb_model.eval()
thermal_model = torch.hub.load('facebookresearch/dino:main', 'dino_vits16').cuda()
thermal_model.train()
