#!/bin/bash
    # --model_names  mmdistill_cart_only_contrastive_all_final_vlad_64_vlad_64 mmdistill_cart_only_contrastive_all_final mmdistill_ms2_only_contrastive_all_final mmdistill_ms2_only_contrastive_all_final_vlad_64 mmdistill_combine_both_cosine_all_final_vlad_64 mmdistill_combine_both_cosine_all_final mmdistill_combine_contrastive_all_final mmdistill_combine_contrastive_all_final_vlad_64 \
...
python3 new_benchmark_vpr.py \
    --model_names mmdistill_ms2_final_vlad_64 mmdistill_ms2_vivid_final_vlad_64 mmdistill_ms2_vivid_freiburg_final_vlad_64 mmdistill_ms2_vivid_freiburg_sthereo_final_vlad_64 mmdistill_ms2_vivid_freiburg_sthereo_boson_final_vlad_64 \
    --dataset cart\
    --top_k_vals 1 5 10 \
    --batch_size 16 \
    --save_qual \
