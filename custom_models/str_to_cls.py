    ...
    if task =='vpr':
        ...
        if name == 'alexnet':
            ...
            if modality == 'rgb':
                ...
                from .mmdistill_dinov2_model import VariableThermalDistillDINOv2FeatureExtractor
                return VariableThermalDistillDINOv2FeatureExtractor(model_type="dinov2_vitb14",use_intermediate_layers=False,backbone_path='/ocean/projects/cis220039p/pmaheshw/code/multi-modal/MultiLoc/pretraining/checkpoints/cart/rgb_thr/2025-06-02_10-22-04/model9.pth')
