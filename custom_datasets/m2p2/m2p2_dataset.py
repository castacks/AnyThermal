...
class M2P2(BaseDataset):
    ...
    """
    def __init__(self,args,db_modality,q_modality,datasets_folder,seq,augment,crop_images,vpr_test=False,vpr_train=False,dist_thresh = 25, rescale_during_crop=False,use_clahe=True, crop_during_vpr_test=False):
        self.subsample =10
