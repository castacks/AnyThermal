...
def return_cart_split(split):
    ...
    if split == "train":
        train_seq_list = ['2022-04-03-12-16-33', '2022-04-03-12-20-57', 
                                ...
                                "2023-03-22-08-44-31","2023-03-22-14-31-06","2023-03-22-14-41-46"
                                ]
        return train_seq_list
    elif split == "val":
        val_seq_list = ['2022-12-20-11-40-28', '2022-12-20-12-16-02', '2022-12-20-12-48-59','2022-12-20-13-37-37'
                             ]
        return val_seq_list
    else:
...
class CART(BaseDataset):
    ...
    """
    def __init__(self,root_frame_dir,db_modality,q_modality,datasets_folder,dist_thresh = 25,vpr_test=False,seq=[]):
