...
parser.add_argument('--save_path', default='./checkpoints_ce/clip_ms2_checkpoints_lidar_global_bigger_denser_no_night', type=str, help='Path to save the checkpoints')
...
rgb_model.eval()
lidar_model = timm.create_model("vit_small_patch16_224",pretrained=True, num_classes=0).cuda()
lidar_model.train()
