...
_DINO_V2_MODELS = Literal["dinov2_vits14", "dinov2_vitb14", \
                        "dinov2_vitl14", "dinov2_vitg14","dinov2_vits14_reg", "dinov2_vitb14_reg"]
...
class DinoV2ExtractFeatures:
    ...
    def __init__(self, dino_model: _DINO_V2_MODELS, layer: int, 
                ...
                norm_descs=True,modality: str = 'rgb', device: str = "cpu") -> None:
        """
            Parameters:
        ...
        # self.dino_model.load_state_dict(torch.load("/ocean/projects/cis220039p/jkarhade/thermal_place_recognition/checkpoints_mse/thermal9.pth")["model_state_dict"])
        if modality=='thermal':
            print('thermal')
            # self.dino_model.load_state_dict(torch.load("/ocean/projects/cis220039p/jkarhade/thermal_place_recognition/checkpoints_mse/thermal9.pth")["model_state_dict"])
            self.dino_model.load_state_dict(torch.load("/ocean/projects/cis220039p/jkarhade/MultiLoc/checkpoints_thermal_global/thermal9.pth")["model_state_dict"])
        elif modality=='lidar':
            print('lidar')
            self.dino_model.load_state_dict(torch.load("/ocean/projects/cis220039p/jkarhade/MultiLoc/checkpoints_lidar_global/lidar9.pth")["model_state_dict"])
...
def get_top_k_recall_video(db: torch.Tensor, 
