...
python3 new_benchmark_vpr.py \
    --model_names salad vpr_mmdistill_salad_boson_freiburg_sthereo_vivid  vpr_mmdistill_salad_boson_freiburg_sthereo_vivid_hard_frac_0.5 vpr_mmdistill_salad_boson_freiburg_sthereo_vivid_margin_0.3 vpr_mmdistill_salad_boson_freiburg_sthereo_vivid_margin_0.3_hard_frac_0.5 vpr_mmdistill_salad_boson_freiburg_sthereo_vivid_margin_0.3_hard_frac_0.25 vpr_mmdistill_salad_boson_freiburg_sthereo_vivid_margin_0.3_hard_frac_0.75\
    --dataset handheld_cart\
    --top_k_vals 1 5 10 \
    --batch_size 16 \
    --save_qual \
    --qual_k 5 \
