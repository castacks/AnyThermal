#!/bin/bash
    ...
    # --model_names mmdistill_ms2_final mmdistill_ms2_vivid_final mmdistill_ms2_vivid_freiburg_final mmdistill_ms2_vivid_freiburg_sthereo_final mmdistill_ms2_vivid_freiburg_sthereo_boson_final  mmdistill_combine_global_contrastive_all_equal_10_final
python3 new_benchmark_vpr.py \
    --model_names mmdistill_vivid_final mmdistill_vivid_freiburg_final mmdistill_vivid_freiburg_sthereo_final mmdistill_vivid_freiburg_sthereo_boson_final mmdistill_combine_global_contrastive_no_ms2_final vpr_mmdistill_frozen_rgb_dinov2_no_ms2\
    --dataset ms2\
    --top_k_vals 1 5 10 \
    --batch_size 16 \
    --save_qual \
