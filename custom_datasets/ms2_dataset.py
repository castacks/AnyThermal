...
def return_ms2_split(split):
    ...
    if split == "train":
        ...
        ms2_seq_list = return_ms2_split("train") + return_ms2_split("val")
        return ms2_seq_list
    else:
...
class MS2(BaseDataset):
    ...
    """
    def __init__(self,args,db_modality,q_modality,datasets_folder,seq,augment,crop_images,vpr_test=False,vpr_train=False,dist_thresh = 15, rescale_during_crop=False,crop_during_vpr_test=False,val_positive_dist_threshold=25, neg_ring_outer_radius = 50):
        self.subsample =10
        self.zone = 52
