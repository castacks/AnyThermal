...
python3 new_benchmark_vpr.py \
    --model_names mmdistill_frozen_dinov2_final mmdistill_frozen_dinov2_final_vlad_64 mmdistill_combine_global_contrastive_no_ms2_final mmdistill_combine_global_contrastive_no_ms2_final_vlad_64 vpr_mmdistill_salad_normal_no_ms2_hard_triplet_vpr_no_ms2\
    --dataset ms2\
    --top_k_vals 1 5 10 \
    --batch_size 16 \
    --save_qual \
