...
python3 new_benchmark_vpr.py \
    --model_names mmdistill_frozen_dinov2_final mmdistill_ms2_final mmdistill_ms2_freiburg_final mmdistill_ms2_freiburg_sthereo_final mmdistill_ms2_freiburg_sthereo_boson_final mmdistill_ms2_freiburg_sthereo_boson_vivid_final  mmdistill_boson_final mmdistill_boson_ms2_final  \
